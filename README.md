...
[#003 - Clean Code - Functions ](https://dev.to/elkhatibomar/003-clean-code-functions-2j57)
...
There is not only a close analogy between the operations of the mind in general reasoning and its operations in the particular science of Algebra, but there is to a considerable extent an exact agreement in the laws by which the two classes of operations are conducted.  - George Boole
---
